...
class DashboardWidgetServiceProvider extends ServiceProvider
{
     ...
     * implement `Modules\SiteEditor\Widgets\Contracts\KeystoneAdminWidgetInterface`;
    ...
    protected array $widgets = [
        'keystone.welcome'           => \Modules\SiteEditor\Widgets\WelcomeWidget::class,
        'keystone.update-banner'     => \Modules\SiteEditor\Widgets\UpdateBannerWidget::class,
        'keystone.site-at-a-glance'  => \Modules\SiteEditor\Widgets\SiteAtAGlanceWidget::class,
        'keystone.recent-activity'   => \Modules\SiteEditor\Widgets\RecentActivityWidget::class,
        'keystone.kpi-tile'          => \Modules\SiteEditor\Widgets\KpiTileWidget::class,
        'keystone.revenue-trend'     => \Modules\SiteEditor\Widgets\RevenueTrendWidget::class,
        'keystone.visitors-trend'    => \Modules\SiteEditor\Widgets\VisitorsTrendWidget::class,
        'keystone.traffic-sources'   => \Modules\SiteEditor\Widgets\TrafficSourcesWidget::class,
        'keystone.recent-orders'     => \Modules\SiteEditor\Widgets\RecentOrdersWidget::class,
        'keystone.recent-leads'      => \Modules\SiteEditor\Widgets\RecentLeadsWidget::class,
        'keystone.order-status'      => \Modules\SiteEditor\Widgets\OrderStatusWidget::class,
        'keystone.lead-funnel'       => \Modules\SiteEditor\Widgets\LeadFunnelWidget::class,
        'keystone.inventory-alerts'  => \Modules\SiteEditor\Widgets\InventoryAlertsWidget::class,
    ];

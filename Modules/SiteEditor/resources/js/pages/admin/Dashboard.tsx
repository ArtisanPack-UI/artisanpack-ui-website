...
import { DashboardGrid, renderableWidgets } from '../../components/DashboardGrid';
import { StarterPicker } from '../../components/StarterPicker';
import { AddWidgetDrawer } from '../../components/AddWidgetDrawer';
import { WidgetSettingsModal } from '../../components/WidgetSettingsModal';
import { WidgetLayoutPopover } from '../../components/WidgetLayoutPopover';
...
export default function Dashboard({ dashboards, current, available_widgets, starters }: DashboardProps) {
    ...
    const defaultHeaderActions = (
        <>
            ...
            <button
                type="button"
                className="rounded-md bg-primary px-3 py-1.5 text-xs font-semibold text-primary-content hover:bg-primary-hover"

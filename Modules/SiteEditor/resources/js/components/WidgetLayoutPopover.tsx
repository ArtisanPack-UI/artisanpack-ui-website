...
export function WidgetLayoutPopover({
    ...
    // committed — leaving the inputs on the previous widget's spans. State is
    ...
    function handleReset() {
        ...
        router.patch(
            ...
            { reset: true } as never,
            {
                ...
                // Without this the popover stays open and silent on a failed
                // reset — `updateWidgetLayout()` 422s when the widget's
                // `default_grid_config` can't be resolved, which is exactly
                // the case a user needs told about. Mirrors handleSubmit.
                onError: (responseErrors) => {
                    setErrors(responseErrors as Record<string, string>);
                },

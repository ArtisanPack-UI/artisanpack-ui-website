...
/**
 * Registers the Privacy module's routes.
 *
 * The module owns admin surfaces only — the public `/api/privacy/*`
 * endpoints belong to the artisanpack-ui/privacy package and are
 * registered by its own provider — so a single `routes/admin.php` is
 * mapped here, reapplying verbatim the outer group the central

...
namespace Modules\Privacy\Http\Controllers\Settings;
 ...
 * {@see \Modules\Privacy\Providers\PrivacyServiceProvider} claims that tab
 * on the `keystone.admin.settings.panels` filter and hydrates it from
 * {@see self::payload()}, so core never names this class. This controller
 * owns the mutation endpoints (update settings + CRUD on categories).
 *

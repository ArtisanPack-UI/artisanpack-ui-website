...
namespace Modules\ContentModel\Policies;
 ...
 * {@see \Modules\ContentModel\Providers\ContentModelServiceProvider}: even if a plugin (or an
...
class DynamicContentEditorModelPolicy
{
     ...
     * {@see \Modules\SiteEditor\Resources\KeystoneResourceResolver} to the target

...
import ConfirmablePasswordController from '@/actions/Modules/Auth/Http/Controllers/ConfirmablePasswordController';
...
export default function ConfirmPassword() {
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        form.post(ConfirmablePasswordController.store().url, {

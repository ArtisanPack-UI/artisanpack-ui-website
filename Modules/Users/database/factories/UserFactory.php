...
class UserFactory extends Factory
{
     ...
     *
     * Stated explicitly because the factory no longer lives under the
     * root `Database\Factories` namespace: Laravel's model guesser
     * strips `Database\Factories\` off the factory's FQCN and looks the
     * remainder up under `App\Models`, which resolves to nothing for a
     * module-namespaced factory. See `newFactory()` on {@see User} for
     * the mirror of this on the model side.
     *

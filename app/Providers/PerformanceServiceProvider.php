 ...
 *      forking Keystone.
 *
 *   4. Bridge the perf package's `CachePurged` event into Keystone's
...
class PerformanceServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        // via `Admin\Settings\PerformanceController`) actually gates
        // the vendor `@perfMonitor` Blade directive. The vendor config
        // ships `monitoring.enabled = true` with no env variable, so
        // without this tie the admin toggle looks like it does nothing.
        //

 ...
 * Performance tab is rendered inline inside `admin/Settings` by
 * {@see \App\Http\Controllers\Admin\KeystoneShellController::settings()},
 * which calls {@see self::payload()} to hydrate the panel; this

...
interface VisitorsTrendData {
    series: RevenueSeries;
}

export function VisitorsTrendWidget({ data }: WidgetComponentProps<VisitorsTrendData>) {
    ...
    const options = {
        ...
        tooltip: {
            ...
            y: { formatter: (v: number) => `${formatNumber(v)} visitors` },
        },
        legend: { show: false },
    };

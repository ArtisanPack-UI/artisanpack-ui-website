...
export default function Edit({ user, assignableRoles }: EditProps) {
    ...
    return (
        <>
            <Head title={`Edit ${user.display_name}`} />
            <div className="flex flex-col gap-7">
                <PageHeader
                    title={`Edit ${user.display_name}`}
                    description="Update this user's profile and role assignments."
                    breadcrumbs={['Users', user.display_name]}
                />

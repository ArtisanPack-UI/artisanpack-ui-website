                ...
                <PageHeader
                    ...
                    actions={
                        <button
                            ...
                            className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-base-300 px-3 py-2 text-xs font-semibold text-base-content/75 hover:bg-base-200 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                                ...
                                <div className="mt-auto flex flex-wrap items-center gap-2">
                                    ...
                                    {plugin.update_available ? (
                                        <button
                                            ...
                                            disabled={isPending}
                                            className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg bg-success px-3 py-2 text-xs font-semibold text-success-content shadow-sm hover:bg-success/90 disabled:cursor-not-allowed disabled:opacity-40"
                                        >
                                            Update
                                        </button>
                                    ) : null}

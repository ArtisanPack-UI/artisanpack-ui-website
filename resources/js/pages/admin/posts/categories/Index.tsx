...
import { destroy, edit, store } from '@/routes/admin/posts/categories';
...
export default function CategoriesIndex() {
    const { categories, parentOptions, errors, flash } =
    ...
    function handleDelete(category: CategoryRow) {
        ...
        router.delete(destroy(category.id).url, { preserveScroll: true });
    }

    const parentLookup = new Map(parentOptions.map((p) => [p.value, p.label]));
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-7">
                <PageHeader
                    title="Categories"
                    description="Organize your blog posts into hierarchical categories."
                    breadcrumbs={['Blog Posts', 'Categories']}
                />
